...
- `thoughts/jbolus/...` → `https://github.com/humanlayer/thoughts/blob/main/repos/humanlayer/jbolus/...`
...
3. **File reference formatting:**
   - Wrap paths in backticks: `thoughts/jbolus/example.md`
...
- jbolus: b157f9e4-8faf-4e7e-a598-dae6dec8a584
